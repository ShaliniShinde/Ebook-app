	...
	<div class="container p-3">
		<div class="row ">
			<div class="col-md-6 text-center p-5 border bg-white">
				<img alt="img" src="book/<%=b.getPhotoNmae()%>"
					style="height: 200px; width: 150px"><br>
				<h4 class="mt-2">
					Book Name : <span class="text-success"><%=b.getBookNmae()%></span>
				</h4>
				<h4>
			...
			<div class="col-md-6 text-center p-5 border bg-white">
				...
				<h6 class="text-primary">
					<i class="fa-solid fa-envelope"></i> Email:<%=b.getEmail()%></h6>
				<%
				}
				%>
